...
def convertYrPdfs(yr, badFiles, startTime):
        ...
        for file in rcFiles:
            ...
            try:
                ...
                headers = ["index", "month", "day", "yr", "lge", "rnd", "session", "trk",
                           ...
                           "run_num", "f_tire", "r_tire", "laps_on_f", "laps_on_r", "lap_num", "lap_time",
                           "lap_seconds", "lap_val", "pit", "sec_one", "one_seconds", "one_val", "sec_two",
                           "two_seconds", "two_val", "sec_thr", "thr_seconds", "thr_val", "sec_four", "four_seconds",
                           "four_val", "avg_spd"]
                ...
                print(f"    Failed Parsing:    {fileName}")
...
for yr in reversed(yrs):
    nueBadFiles = convertYrPdfs(yr, badFiles, startTime)
    badFiles.append(nueBadFiles)
